...
\section{Choix de Style : Français / Darija}

Un choix délibéré a été fait pour donner une identité unique au projet :

\begin{itemize}
    \item \textbf{Code interne} : Variables et fonctions en français académique (\texttt{ajouter\_etat}, \texttt{nb\_symboles})
    \item \textbf{Messages utilisateur} : Output en dialecte marocain Darija (Arabizi) pour une touche personnelle authentique
\end{itemize}

\textit{Exemple de message :}
\begin{center}
    \texttt{"Bdit kan-analysi l'automate: MonAutomate1..."}
\end{center}

Cette approche reflète l'identité d'un étudiant marocain francophone tout en maintenant un code professionnel.
