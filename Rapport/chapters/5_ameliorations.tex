...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth, height=0.4\textheight, keepaspectratio]{images/erreur_determinisme.png}
    \caption{Validation sémantique : Détection et rejet d'un automate non-déterministe.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth, height=0.4\textheight, keepaspectratio]{images/simulation_execution.png}
    \caption{Trace d'exécution du simulateur : Acceptation ('Nadi') et Rejet ('Dommage') avec messages en Darija.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth, keepaspectratio]{images/simulation_execution_visualisation_Graphviz.png}
    \caption{Visualisation graphique de l'automate générée automatiquement par le compilateur.}
    \label{fig:graphviz}
\end{figure}
