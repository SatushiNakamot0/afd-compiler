...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_automate_def = 22,              /* automate_def  */
  YYSYMBOL_23_1 = 23,                      /* $@1  */
  YYSYMBOL_identifier = 24,                /* identifier  */
  YYSYMBOL_sections = 25,                  /* sections  */
  YYSYMBOL_section = 26,                   /* section  */
  YYSYMBOL_alphabet_section = 27,          /* alphabet_section  */
  YYSYMBOL_char_list = 28,                 /* char_list  */
  YYSYMBOL_etats_section = 29,             /* etats_section  */
  YYSYMBOL_identifier_list = 30,           /* identifier_list  */
  YYSYMBOL_initial_section = 31,           /* initial_section  */
  YYSYMBOL_finaux_section = 32,            /* finaux_section  */
  YYSYMBOL_final_list = 33,                /* final_list  */
  YYSYMBOL_transitions_section = 34,       /* transitions_section  */
  YYSYMBOL_transition_list = 35,           /* transition_list  */
  YYSYMBOL_transition = 36                 /* transition  */
};
...
{
       0,   203,   203,   222,   221,   233,   237,   238,   242,   243,
     244,   245,   246,   250,   254,   258,   265,   269,   274,   282,
     290,   294,   299,   307,   311,   312,   316
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TOK_STRING", "TOK_CHAR", "'{'", "'}'", "'='", "';'", "','", "':'",
  "$accept", "program", "automate_def", "$@1", "identifier", "sections",
  "section", "alphabet_section", "char_list", "etats_section",
  "identifier_list", "initial_section", "finaux_section", "final_list",
  "transitions_section", "transition_list", "transition", YY_NULLPTR
};
...
{
      11,     6,    19,    -4,    -4,    10,    -4,    -4,     2,     9,
      13,    15,    16,    17,    -3,    -4,    -4,    -4,    -4,    -4,
      -4,    12,    20,     6,    21,    22,    -4,    -4,    14,     6,
      23,     6,     6,    -4,    -2,    -4,     3,    -4,    -4,     5,
      18,     0,    -4,    24,    25,    26,     6,    27,     6,    29,
      31,    -4,    -4,    -4,    -4,    -4,    -4,    -4,    36,    -4,
       6,    32,    -4
};
...
static const yytype_int8 yydefact[] =
{
      ...
      12,     0,     0,     0,     0,     0,     4,     7,     0,     0,
       0,     0,     0,    14,     0,    17,     0,    19,    21,     0,
       0,     0,    24,     0,     0,     0,     0,     0,     0,     0,
       0,    25,    13,    15,    16,    18,    20,    22,     0,    23,
       0,     0,    26
};
...
{
       0,     2,     3,     8,    40,    14,    15,    16,    34,    17,
      36,    18,    19,    39,    20,    41,    42
};
...
{
       5,     9,    10,    11,    12,    13,     9,    10,    11,    12,
      13,     4,    26,    43,     1,    50,    44,     4,    45,     6,
      47,    46,    30,    48,     7,    21,    28,    33,    35,    22,
      38,    23,    24,    25,    29,    31,    32,    49,    53,     0,
      37,    52,    58,    54,    56,    55,    60,    57,    59,    62,
       0,    27,     0,     0,     0,     0,     0,     0,     0,    61,
...
{
       1,     4,     5,     6,     7,     8,     4,     5,     6,     7,
       8,    11,    15,    15,     3,    15,    18,    11,    15,     0,
      15,    18,    23,    18,    14,    16,    14,    13,    29,    16,
      31,    16,    16,    16,    14,    14,    14,    19,    13,    -1,
      17,    17,    13,    17,    17,    46,    10,    48,    17,    17,
      -1,    14,    -1,    -1,    -1,    -1,    -1,    -1,    -1,    60,
...
{
       0,     3,    21,    22,    11,    24,     0,    14,    23,     4,
       5,     6,     7,     8,    25,    26,    27,    29,    31,    32,
      34,    16,    16,    16,    16,    16,    15,    26,    14,    14,
      24,    14,    14,    13,    28,    24,    30,    17,    24,    33,
      24,    35,    36,    15,    18,    15,    18,    15,    18,    19,
      15,    36,    17,    13,    17,    24,    17,    24,    13,    17,
      10,    24,    17
};
...
#line 222 "parser.y"
    {
        current_automaton = init_automaton((yyvsp[-1].str));
        printf("Parsing automaton: %s\n", (yyvsp[-1].str));
    }
#line 1334 "parser.tab.c"
    break;

  case 4: /* automate_def: TOK_AUTOMATE identifier '{' $@1 sections '}'  */
#line 227 "parser.y"
    {
        free((yyvsp[-4].str));
    }
#line 1342 "parser.tab.c"
  ...
  case 5: /* identifier: TOK_IDENTIFIER  */
#line 233 "parser.y"
                   { (yyval.str) = (yyvsp[0].str); }
#line 1348 "parser.tab.c"
    break;

  case 14: /* char_list: TOK_CHAR  */
#line 255 "parser.y"
    {
        add_symbol((yyvsp[0].c));
    }
#line 1356 "parser.tab.c"
    break;

  case 15: /* char_list: char_list ',' TOK_CHAR  */
#line 259 "parser.y"
    {
        add_symbol((yyvsp[0].c));
    }
...
#line 1382 "parser.tab.c"
  ...
  case 19: /* initial_section: TOK_INITIAL '=' identifier ';'  */
#line 283 "parser.y"
    {
        set_initial((yyvsp[-1].str));
        free((yyvsp[-1].str));
    }
#line 1391 "parser.tab.c"
    break;

  case 21: /* final_list: identifier  */
#line 295 "parser.y"
    {
        add_final((yyvsp[0].str));
        free((yyvsp[0].str));
    }
#line 1400 "parser.tab.c"
    break;

  case 22: /* final_list: final_list ',' identifier  */
#line 300 "parser.y"
    {
        add_final((yyvsp[0].str));
        free((yyvsp[0].str));
...
#line 1409 "parser.tab.c"
  ...
  case 26: /* transition: identifier ':' TOK_CHAR TOK_ARROW identifier ';'  */
#line 317 "parser.y"
    {
        add_transition((yyvsp[-5].str), (yyvsp[-3].c), (yyvsp[-1].str));
        free((yyvsp[-5].str));
        free((yyvsp[-1].str));
    }
